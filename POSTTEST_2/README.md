...
Program ini juga menerapkan konsep **Encapsulation** dengan menggunakan access modifier **private** pada atribut serta menyediakan **method Getter dan Setter** untuk mengakses dan mengubah data. Hal ini membuat data menjadi lebih aman dan terkontrol.

Melalui program ini, pengguna dapat mengelola data produk elektronik secara sederhana melalui menu yang disediakan. Selain itu, program ini juga melatih pemahaman mengenai penggunaan **class, object, encapsulation, getter dan setter, array list, perulangan, percabangan, serta validasi input** dalam pengembangan aplikasi berbasis objek.
