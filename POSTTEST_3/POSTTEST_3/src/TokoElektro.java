...
public class TokoElektro {
    ...
    static void tampilLaptop() {
        ...
        for (Laptop l : daftarLaptop) {
            ...
            System.out.println("Seri : " + l.getSeri());
    ...
    static void tampilTv() {
        for (Tv t : daftarTv) {
            System.out.println("\nID : " + t.getID());
            System.out.println("Merk : " + t.getMerk());
            System.out.println("Seri : " + t.getSeri());
    ...
    static void tampilKulkas() {
        for (Kulkas k : daftarKulkas) {
            ...
            System.out.println("Pintu : " + k.getPintu());
    ...
    static void tampilAC() {
        for (AC a : daftarAC) {
            ...
            System.out.println("Seri : " + a.getSeri());
            System.out.println("PK : " + a.getPk());
        }
    }
