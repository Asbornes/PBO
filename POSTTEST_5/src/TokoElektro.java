...
public class TokoElektro {
    ...
    static ArrayList<Laptop> daftarLaptop;
    static ArrayList<Tv> daftarTv;
    static ArrayList<Kulkas> daftarKulkas;
    static ArrayList<AC> daftarAC;
    ...
    static {
        ...
        daftarLaptop = new ArrayList<>();
        daftarTv = new ArrayList<>();
        daftarKulkas = new ArrayList<>();
        daftarAC = new ArrayList<>();
    }
}